...
import { User, MapPin, Mail, Lock, Package } from "lucide-react";
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      ...
      <div className="space-y-6">
        ...
        <Card
          className="hover:border-green-200 transition-colors cursor-pointer"
        ...
        >
          ...
          <CardContent>
            <div className="text-2xl font-bold">Ver mis compras</div>
            <p className="text-xs text-muted-foreground">
              Revisa el estado de tus pedidos y recogidas.
            </p>
          </CardContent>
        </Card>
      </div>
